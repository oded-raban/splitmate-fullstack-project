...
*The goal is to ensure you know what you are building before you start writing code.*
...
*The product must be accessible via a public URL, not just running locally on your machine.*
...
*The goal is to demonstrate that you can define what it means for a product to "work."*
...
*You don't need 100% code coverage, but key product workflows must be tested.*
...
*However, full accountability for the code remains yours.* By the end of the project, you must review all code, understand it thoroughly, and be able to justify why every library, component, pattern, and technical decision was chosen.
...
**Crucial:** You must know your product **inside and out**. It is not enough for the app to function — you must explain *how* and *why* it functions. Treat this as a brief technical job interview on work you delivered.
